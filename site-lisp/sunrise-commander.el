...
(defcustom sr-show-file-attributes nil
...
(defun sr-moubse-advertised-find-file (e)
...
(sr-rainbow sr-html-face              (:foreground "khaki")                 "\\(^[^!].[^d].*\\.x?html?$\\)")
(sr-rainbow sr-css-face               (:foreground "DarkKhaki")             "\\(^[^!].[^d].*\\.x?css?$\\)")
(sr-rainbow sr-xml-face               (:foreground "DarkGreen")             "\\(^[^!].[^d].*\\.\\(xml\\|xsd\\|xslt?\\|wsdl\\)$\\)")
(sr-rainbow sr-img-face               (:foreground "LightGreen")            "\\(^[^!].[^d].*\\.\\(jpg\\|png\\|gif\\|jpeg\\)$\\)")
(sr-rainbow sr-ipt-face               (:bold t :foreground "yellow")        "\\(^[^!].[^d].*\\.\\(emacs\\)$\\)")
