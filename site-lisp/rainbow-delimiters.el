...
;;  '((((background light)) (:foreground "limegreen"))
...
(defface rainbow-delimiters-depth-2-face
  '((((background light)) (:foreground "#F2BE2F"))
    (((background dark)) (:foreground "#F2BE2F")))
  "Nested delimiters face, depth 2."
  :group 'rainbow-delimiters-faces)

(defface rainbow-delimiters-depth-3-face
  '((((background light)) (:foreground "#87F0F0"))
    (((background dark)) (:foreground "#87F0F0")))
...
(defface rainbow-delimiters-depth-5-face
  '((((background light)) (:foreground "#7270AB"))
    (((background dark)) (:foreground "#7270AB")))
  "Nested delimiters face, depth 5."
  :group 'rainbow-delimiters-faces)

(defface rainbow-delimiters-depth-6-face
  '((((background light)) (:foreground "#FFC526"))
    (((background dark)) (:foreground "#FFC526")))
